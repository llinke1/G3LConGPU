...
int main(int argc, char* argv[])
{
  ...
  if(g3lcong::readLenses2Dev(filename_sources, 7, 1, 2, 7, tmp,
			      tmp, zS)) return 1;

  if(g3lcong::readLenses2Dev(filename_lenses1, 7, 1, 2, 7, x1, y1, z1)) return 1;
  if(g3lcong::readLenses2Dev(filename_lenses2, 7, 1, 2, 7, x2, y2, z2)) return 1;
