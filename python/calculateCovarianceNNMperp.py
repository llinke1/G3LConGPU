## @package calculateCovarianceNNMperp.py
# Calculate Covariancematrix and Stddev of <N2Mperp> from Jackknife samples
#
...
message="""
# calculateCovarianceNNMperp.py: WRONG NUMBER OF ARGUMENTS
# Usage: calculateCovarianceNNMperp.py Outputfile_Covariance_Matrix
#	 Outputfile_StandardDeviations NNMap_Jackknifes
#
# Example: calculateCovarianceNNMerp.py 
#	   ../../products/NNMap/all.b_mode_covariance.dat
#	   ../../products/NNMap/all.b_mode_stddev.dat
