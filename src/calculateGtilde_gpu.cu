...
int main(int argc, char *argv[])
{
  ...
  // x,y, z vectors
  std::vector<double> x1, y1, z1, x2, y2, z2, xS, yS, e1, e2, w;

  if (g3lcong::readSources2Dev(filename_sources, 6, 1, 2, 3, 4, 6, xS,
                               yS, e1, e2, w, flipE1, flipE2))
    return 1;

  if (g3lcong::readLenses2Dev(filename_lenses1, 6, 1, 2, 5, x1, y1, z1))
    return 1;
  if (g3lcong::readLenses2Dev(filename_lenses2, 6, 1, 2, 5, x2, y2, z2))
    return 1;
  ...
  if (physical)
  {
    g3lcong::addToGtildePhysical<<<BLOCKS, THREADS>>>(dev_x1, dev_y1,
                                                      dev_x2, dev_y2,
                                                      dev_xS, dev_yS,
                                                      dev_z1, dev_z2,
                                                      dev_e1, dev_e2,
                                                      dev_w, dev_omega,
                                                      sigma2, dev_sigma_crit,
                                                      dev_angular_distance,
                                                      omega_theta_min,
                                                      omega_theta_max,
                                                      sigma_crit_z_min,
                                                      sigma_crit_z_max,
  ...
  {
    g3lcong::addToGtilde<<<BLOCKS, THREADS>>>(dev_x1, dev_y1, dev_x2, dev_y2,
                                              dev_xS, dev_yS, dev_z1, dev_z2,
                                              dev_e1, dev_e2, dev_w,
                                              dev_omega,
